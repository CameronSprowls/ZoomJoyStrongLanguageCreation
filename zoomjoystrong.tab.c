...
static const char *const yytname[] =
{
  ...
  "program", "statement_list", "statement", "statement_point",
  "statement_line", "statement_circle", "statement_rectangle",
  "statement_set_color", "end_program", YY_NULLPTR
};
#endif
